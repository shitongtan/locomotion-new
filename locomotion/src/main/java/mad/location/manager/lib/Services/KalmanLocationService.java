...
public class KalmanLocationService extends Service
    ...
    public static class Settings {
        ...
        public Settings(double accelerometerDefaultDeviation, int gpsMinDistance, int gpsMinTime, int geohashDefaultPrec, int geohashDefaultMinPointCount, double sensorDefaultFreqHz, Object o, boolean b, double defaultVelFactor, double defaultPosFactor) {
                this.accelerationDeviation = accelerometerDefaultDeviation;
                this.gpsMinDistance = gpsMinDistance;
                this.gpsMinTime = gpsMinTime;
                this.geoHashPrecision = geohashDefaultPrec;
                this.geoHashMinPointCount = geohashDefaultMinPointCount;
                this.sensorFrequencyHz = sensorDefaultFreqHz;
                this.mVelFactor = defaultVelFactor;
                this.mPosFactor = defaultPosFactor;
                this.filterMockGpsCoordinates = b;
        }
    }
