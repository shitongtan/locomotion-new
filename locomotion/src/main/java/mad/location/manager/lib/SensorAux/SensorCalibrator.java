...
public class SensorCalibrator implements SensorEventListener {
    ...
    public int getAbsCalibration(){
        return Integer.valueOf((int) m_dcAbsLinearAcceleration.getCompletePercentage());
    }

    public String getCalibrationStatus()  {
        Log.d("calibrating", String.valueOf(m_dcAbsLinearAcceleration));

        return String.format("abs:%f%%"+ "\n" + "lin::%f%%\n",
