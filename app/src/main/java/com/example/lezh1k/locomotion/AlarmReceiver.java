...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setAlarm(Context context) {
        ...
        Intent i = new Intent(context, com.example.lezh1k.locomotion.AlarmReceiver.class);
    ...
    public void cancelAlarm(Context context) {
        Intent intent = new Intent(context, com.example.lezh1k.locomotion.AlarmReceiver.class);
