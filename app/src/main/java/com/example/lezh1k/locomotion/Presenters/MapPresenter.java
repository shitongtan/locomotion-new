package com.example.lezh1k.locomotion.Presenters;
...
import com.example.lezh1k.locomotion.MainActivity;
...
public class MapPresenter implements LocationListener {
    ...
    private List<Location> m_mapMatching = new ArrayList<>();
